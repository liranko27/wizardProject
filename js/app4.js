...
const updateWizardDetailsSummary = () => {
  ...
  emailCardText.innerText = wizardDetailsObj.phase1.email;
  const birthDateText = document.createElement("p");
  birthDateText.classList.add("card-text");
  birthDateText.innerText = wizardDetailsObj.phase1.birthDate;
  ...
  hobbiesText.innerText = wizardDetailsObj.phase3.hobbies.join(",");
